...
with zipfile.ZipFile(sys.argv[1]) as package:
    ...
    assert entry[0]==resource_hash('mods/cowboybingus/shallow_water_dive') and entry[1]==0xa14e8dfa2cd117e2
...
print('PASS: sole dive resource, loader dependency, bytecode mode, hashes and no executable payload')
